import type { FlowNode, HandleSide, Rect, Viewport, XYPosition } from '../models/FlowTypes';
import type { HandleDefinition, NodeTypeDefinition, NodeTypeRegistry } from '../models/NodeTypes';
 ...
 */
export function getHandleOffset(def: NodeTypeDefinition, handle: HandleDefinition, width: number, height: number): XYPosition {
...
export function getHandlePosition(node: FlowNode, def: NodeTypeDefinition, handle: HandleDefinition): XYPosition {
...
export function findHandle(def: NodeTypeDefinition, kind: HandleDefinition['kind'], id?: string): HandleDefinition | undefined {
