...
import { useFlowState } from '../../hooks/FlowContext';
import styles from './FlowCanvas.module.css';

export type BackgroundVariant = 'dots' | 'lines' | 'none';

/** Grid pattern that moves and scales with the viewport. */
export const Background = memo(function Background({ variant = 'dots' }: { variant?: BackgroundVariant }) {
  ...
  return (
    <svg className={styles.background} aria-hidden="true">
