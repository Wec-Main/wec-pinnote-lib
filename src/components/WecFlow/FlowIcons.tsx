...
import type { BuiltInIcon } from "../../utils/flowchart/nodeTypes";
...
const paths = {
  ...
  globe:
    "M12 3a9 9 0 1 0 0 18 9 9 0 0 0 0-18z M3 12h18 M12 3c2.5 2.5 3.5 5.5 3.5 9s-1 6.5-3.5 9c-2.5-2.5-3.5-5.5-3.5-9s1-6.5 3.5-9z",
  mail: "M3.5 6h17v12h-17z M4 6.5l8 6.5 8-6.5",
  database:
    "M5 6c0-1.7 3.1-3 7-3s7 1.3 7 3-3.1 3-7 3-7-1.3-7-3z M5 6v12c0 1.7 3.1 3 7 3s7-1.3 7-3V6 M5 12c0 1.7 3.1 3 7 3s7-1.3 7-3",
  ...
  collapse: "M4 10V5h5 M4 14v5h5 M20 10V5h-5 M20 14v5h-5",
